...
- Treat ServiceNow deletion as prohibited by default in this repository.
...
- If a user asks to delete records, state that deletion is intentionally disabled in SPIE and recommend controlled cleanup via approved ServiceNow admin process.
