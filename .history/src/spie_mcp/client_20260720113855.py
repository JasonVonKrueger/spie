...
class ServiceNowClient:
    ...
    def create_record(
        ...
        *,
        ...
        if table == "sys_update_set" and not allow_protected_tables:
            raise ServiceNowError(
                "Direct sys_update_set creation is blocked. Use the strict create_update_set flow so naming convention validation is enforced."
            )
    ...
    def update_record(
        ...
        *,
        ...
        if table == "sys_update_set" and "name" in payload and not allow_protected_tables:
            raise ServiceNowError(
                "Direct sys_update_set renames are blocked. Use the strict update_update_set flow so naming convention validation is enforced."
            )
