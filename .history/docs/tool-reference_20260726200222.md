...
- If ATF bundle creation fails after partial create operations, the server reports manual cleanup details and does not execute delete rollback.
- Delete operations are intentionally disabled for safety in this MCP implementation.
