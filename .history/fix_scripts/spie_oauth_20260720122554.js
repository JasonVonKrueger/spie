(function executeFixScript() {
    var CONFIG = {
        ...
        description: 'OAuth application registry for the SPIE MCP server connection to ServiceNow.',
    ...
    assignFirstValid(registry, ['description', 'short_description'], CONFIG.description);
    ...
    assignFirstValid(registry, ['client_type'], CONFIG.confidential ? 'confidential' : 'public');
    assignFirstValid(registry, ['active'], CONFIG.active);
    assignFirstValid(registry, ['is_confidential', 'confidential'], CONFIG.confidential);
